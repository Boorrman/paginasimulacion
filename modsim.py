...
def inventario_EOQ():
    ...
    if request.method == 'POST' and form.validate():
        ...
        return render_template('/metspages/modsim/inventeoq.html', form=form, tables=[df.to_html(classes='data')], grafica=plotfile, dato1=Q,
...
def inventario_general():
    ...
    if request.method == 'POST' and form.validate():
        ...
        return render_template('/metspages/modsim/inventgen.html', form=form, tables=[df.to_html(classes='data')])
    else:
        D = None
        CO = None
        P = None
...
def inventario_empresa():
    ...
    if request.method == 'POST' and form.validate():
        ...
        return render_template('/metspages/modsim/invtpaez.html', form=form, tables=[df.to_html(classes='data')], tables2=[df2.to_html(classes='data')], grafica=plotfile, dato1=Q,
        dato2=CoT,dato3=ChT,dato4=MOQ,dato5=CTT,dato6=N,dato7=R,dato8=T)
    else:
        D = None
        CO = None
